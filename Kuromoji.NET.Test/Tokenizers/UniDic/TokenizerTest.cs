...
namespace Kuromoji.NET.Test.Tokenizers.UniDic
{
    ...
    public class TokenizerTest
    {
        ...
        public void TestNucleus()
        {
            ...
            var expectedFeatures = "名詞,普通名詞,一般,*,*,*,カク,核,核,カク,核,カク,漢,*,*,ク促,基本形";
        ...
        {
            Tokenizer.IsSameTokenizedStream("Input\\UniDic\\bocchan-unidic-features.txt", "Input\\UniDic\\bocchan.txt");
        }
